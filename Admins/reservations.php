...
try {
    ...
    $sql = "SELECT r.*, v.villeDepart, v.villeArrivee, v.jourDepart, v.heureDepart
            FROM reservation r
        ...
        <table class="min-w-full bg-white border border-gray-300 rounded-lg shadow-md">
            ...
            <tbody>
                <?php foreach ($reservations as $reservation): ?>
                    <tr class="border-b">
                        <td class="py-2 px-4 text-center"><?= htmlspecialchars($reservation['id_reservation']) ?></td>
                        ...
                        <td class="py-2 px-4 text-center">
                            <form method="POST" onsubmit="return confirm('Voulez-vous vraiment supprimer cette réservation ?');">
                                <input type="hidden" name="reservation_id" value="<?= htmlspecialchars($reservation['id_reservation']) ?>">
                ...
                <?php if (empty($reservations)): ?>
                    <tr>
                        <td colspan="13" class="text-center py-4 text-gray-500">Aucune réservation trouvée.</td>
                    </tr>
                <?php endif; ?>
            </tbody>
        </table>
