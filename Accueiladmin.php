...
<body>
    ...
    <div id="box">
        <form action="#" method="POST">
            <h2>Veuillez insérer un trajet de voyage</h3>
                <hr><br>
                <div>
                    <label>Depart :</label>

                    <select id="input1" name="depart" aria-placeholder="20 places"
                        style="width: 250px; height: 37px; border-radius: 5px; margin-left: 90px;">
                ...
                <div>
                    <label>Arrivée :</label>
                    <select id="input1" name="arrivee" aria-placeholder="20 places"
                        style="width: 250px; height: 37px; border-radius: 5px;  margin-left: 84px;">
                        <option value="Douala">Douala</option>
                        <option value="Yaounde">Yaounde</option>
                        <option value="Bafoussam">Bafoussam</option>
                        <option value="Mbouda">Mbouda</option>
                ...
                <div class="form-group">
                    ...
                    <select id="select" name="select" aria-placeholder="2 places"
                        style="width: 250px; height: 37px; border-radius: 5px;  margin-left: 52px;">
                ...
                <div>
                    ...
                    <input type="time" id="cni" name="partir" style=" margin-left: 41px; width: 250px; height: 37px;">
                </div><br>
                <div>
                    <label>heure d'arrivée :</label>
                    <input type="time" id="cni" name="destination"
                        style=" margin-left: 22px; width: 250px; height: 37px;">
                </div> <br>
                <div>
                    <label>jour Depart :</label>
                    <input type="date" class="date-input" name="date"
                        style=" margin-left: 50px; width: 236px; height: 23px;">
                </div><br>
                <div>
                    <label>prix :</label>
                    <input type="text" id="cni" name="prix" class="class3"
                        style=" margin-left: 107px; width: 250px; height: 34px;">
                </div><br><br>
                <div class="bouton">
