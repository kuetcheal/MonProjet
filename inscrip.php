...
$password = $_POST['password']; // Récupérer le mot de passe soumis par l'utilisateur via un formulaire

// Vérifier si le mot de passe contient à la fois des lettres et des nombres entiers
if (preg_match('/[a-zA-Z]/', $password) && preg_match('/\d/', $password)) {
    // Le mot de passe est valide, rediriger vers accueil.php
    header('Location: nav.php');
    exit;
} else {
    // Le mot de passe est invalide, afficher un message d'erreur par exemple
    echo "Le mot de passe doit contenir à la fois des lettres et des nombres entiers.";
    exit; // Ajout de cette ligne pour arrêter l'exécution du script après l'affichage du message d'erreur
}
}
?>
